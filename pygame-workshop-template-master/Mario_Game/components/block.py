...
class Block(pygame.sprite.Sprite):
    ...
    def generatePipes():  # *SIMPLIFY
        ...
        s = "Mario_Game/assets/block_pipe_short.png"
        m = "Mario_Game/assets/block_pipe_medium.png"
        l = "Mario_Game/assets/block_pipe_long.png"
    ...
    def generatePlatform():
        ...
        # y location = 360
        mystery = "Mario_Game/assets/block_mystery.png"
        tile = "Mario_Game/assets/block_tile.png"
