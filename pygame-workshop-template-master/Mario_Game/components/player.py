...
class Player(pygame.sprite.Sprite):
    def __init__(self, res):
        ...
        self.image = pygame.image.load('Mario_Game/assets/player_idle_right.png')
    ...
    def updateSprite(self):
        ...
        if self.direction:
            if self.jumping:
                self.image = pygame.image.load('Mario_Game/assets/player_jump_right.png')
            else:
                self.image = pygame.image.load('Mario_Game/assets/player_idle_right.png')
        # otherwise if facing left
        else:
            if self.jumping:
                self.image = pygame.image.load('Mario_Game/assets/player_jump_left.png')
            else:
                self.image = pygame.image.load('Mario_Game/assets/player_idle_left.png')
        # if falling (directionless)
        if self.falling:
            self.image = pygame.image.load('Mario_Game/assets/player_falling.png')
